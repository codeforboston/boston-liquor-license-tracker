    ...
    <section className="license-type p-[32px] bg-[#FDFDFD]">
      ...
      <p className="mt-[8px] mb-[16px] font-normal text-[16px]">
        <FormattedMessage
          ...
          defaultMessage={
            "In 2024 the city of Boston passed a new law to increase access to liquor licenses in several parts of Boston. Through this law the city will be issuing 5 new on-premise liquor licenses to 13 of Boston's Zip Codes each year for the next 3 years."
          }
        />
      </p>
      <h4 className="font-medium text-[24px]">
